...
#colnames(var)<-cols
var <- var %>% arrange(adj.P.Val, P.Value) %>% rowid_to_column("Rank")
...
<!-- # p_data  -->
<!-- #  -->
<!-- # cont_var_normality(params$p_data, var) -->
<!-- # ``` -->
...
var %>%
    ...
    options = list(pageLength = 15,
                   ...
                   buttons = list(
                     ...
                     list(
                       ...
                       text = 'simplified',
                       show = c(0,1,3,6,8),
                       hide = c(2,4,5,7,9,10,11,12,13,14,15,16)
                       ),
                     list(
                       extend = 'colvisGroup',
                       text = 'show all',
  ...
  DT::formatStyle(columns = c(1:12, 14), `text-align` = 'center') %>%
  DT::formatStyle(columns = c(16,17), `text-align` = 'left') %>%
  DT::formatStyle(
    'adj.P.Val',
...
```{r qqplot and nom. p value histogram, echo=FALSE, message=FALSE, warning=FALSE}
...
<!-- ## Regression function qqplot & p.value {.tabset .tabset-fade .tabset-pills} -->
